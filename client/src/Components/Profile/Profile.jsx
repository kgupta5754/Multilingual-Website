  ...
  return (
    <div className="margin-auto shadow-2xl h-96 w-11/12 ml-16 ">
      <h1 className="ml-44 mt-10">
        <strong className="text-sky-500 text-2xl pl-32 font-extrabold italic">
          {/* Sweat more in practice, bleed less in war. */}
          WELCOME TO WORD WEAVE,
        </strong>{" "}
      ...
      <div className="border-red-500 absolute  bg-sky-300 rounded-2xl right-24 top-44 border-2 mb-8 p-1 pl-2  pr-2 ">
        <Link to="/">
